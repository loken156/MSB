...
export const addShelf = async (shelfData) => {
  const requestBody = {
    newShelf: {
      shelfId: shelfData.shelfId || "00000000-0000-0000-0000-000000000000", // Убедитесь, что это валидный GUID, если shelfId не указан
    ...
    warehouseName: shelfData.warehouseName, // Это поле уже включено в объект как дополнительный параметр
  };
